  ...
  return (
    <div
      className={`max-h-screen min-h-screen overflow-hidden bg-white ${
        isHovered
          ? "invert-0 transition ease-in-out duration-300"
          : "invert transition ease-in-out duration-300"
      }`}
    >
      <div className="relative z-10 w-full pt-20 font-bold text-center text-black sm1:text-2xl md:text-4xl">
        Oops! Page not found
      </div>
      ...
      <div className="relative z-20 flex justify-center m-auto border-0 border-red-500 sm1:-mt-10 lg:-mt-10 2xl:-mt-20 2xl:lg:w-2/5 lg:w-3/5 sm2:w-4/5">
        <button
          onMouseEnter={getHover}
          onMouseLeave={escapeHover}
          className="md:w-1/3 sm1:p-2 md:p-4 m-auto font-bold text-center text-black border-2 border-black rounded-0 hover:scale-[1.1] transform transition ease-in-out duration-300"
        >
          <Link href="/" className="">
            Back to Home
          </Link>
